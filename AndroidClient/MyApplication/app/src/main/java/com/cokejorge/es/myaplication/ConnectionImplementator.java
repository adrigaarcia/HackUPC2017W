...
/**
 *  Clase encargada de realizar todas las comunicaciones con el servidor
 */
public class ConnectionImplementator {

    //TODO: LANZA EL SERVIDOR E INSERTA LA URL AQUI (terminado en "/"):
    public static String url = "INSERTA TU URL AQUI (EJ: http://localhost:8080/";
